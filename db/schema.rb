...
ActiveRecord::Schema.define(version: 20180307141043) do
  ...
  create_table "qualified_leads", force: :cascade do |t|
    t.integer "lead_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lead_id"], name: "index_qualified_leads_on_lead_id"
  end
